...
export const ShowXepHang = (new Date().getMonth() == 4 || (new Date().getMonth() == 5 && new Date().getDate() <= 5));
//export const ShowXepHang = (new Date().getMonth() == 3 || new Date().getMonth() == 4 || (new Date().getMonth() == 5 && new Date().getDate() <= 5));
